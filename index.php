...
$controllers = ["home","form","connection","signup"];
...
if (is_readable($nom_fichier)) {
    ...
    die("Error 404: j'ai pas trouvé ton controleur $nom_fichier, ajoute le dans la liste des controllers dans index.php");
}
